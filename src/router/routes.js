...
export default [
  {
    ...
    component: () => import("../views/taxi/Dashboard.vue")
  },
  {
    path: "/login",
    name: "login",
  ...
  // },
  {
    ...
    component: () => import("../views/taxi/Profile.vue")
  },
  // ========== dispetcher
  {
    path: "/dispetcher",
    name: "dispetcher",
    meta: { title: "Dispetchers", authRequired: true },
    component: () => import("../views/taxi/dispetchers/List.vue")
  },
  {
    path: "/dispetcher/create",
    name: "dispetcher_create",
    meta: { title: "Dispetcher create", authRequired: true },
    component: () => import("../views/taxi/dispetchers/Add.vue")
  },
  {
    path: "/dispetcher/detail/:id",
    name: "dispetcher_detail",
    meta: { title: "Dispetcher detail", authRequired: true },
    component: () => import("../views/taxi/dispetchers/Detail.vue")
  },
  // ========== dispetcher
  {
    path: "/dispetcher/panel",
    name: "dispetcher_panel",
    meta: { title: "Dispetcher Panel", authRequired: true },
    component: () => import("../views/taxi/dispetcher/Dispetcher.vue")
  },
  // ========== driver
  {
    path: "/driver",
    name: "driver",
    meta: { title: "Haydovchilar", authRequired: true },
    component: () => import("../views/taxi/driver/List.vue")
  },
  {
    path: "/driver/create",
    name: "driver_create",
    meta: { title: "Haydovchi qo'shish", authRequired: true },
    component: () => import("../views/taxi/driver/Add.vue")
  },
  {
    path: "/driver/detail/:id",
    name: "driver_detail",
    meta: { title: "Haydovchi detail", authRequired: true },
    component: () => import("../views/taxi/driver/Detail.vue")
  },
  ...
  // balance
  {
    path: "/balance",
    name: "balance",
    meta: { title: "Balans", authRequired: true },
    component: () => import("../views/taxi/balance/List.vue")
  },
  {
    path: "/balance/create",
    name: "balance_create",
    meta: { title: "Balans to'ldirish", authRequired: true },
    component: () => import("../views/taxi/balance/Add.vue")
  },
  {
    path: "/balance/detail/:id",
    name: "balance_detail",
    meta: { title: "Balans detail", authRequired: true },
    component: () => import("../views/taxi/balance/Detail.vue")
  },
  ...
  // order
  {
    path: "/orders",
    name: "orders",
    meta: { title: "Buyurtmalar", authRequired: true },
    component: () => import("../views/taxi/orders/List.vue")
  },
  {
    path: "/orders/detail/:id",
    name: "order_detail",
    meta: { title: "Buyurtma detail", authRequired: true },
    component: () => import("../views/taxi/orders/Detail.vue")
  },
  ...
  // address-category
  {
    ...
    meta: { title: "Manzil guruhlari", authRequired: true },
    component: () => import("../views/taxi/address-category/List.vue")
  },
  {
    path: "/address/category/create",
    name: "address_category_create",
    meta: { title: "Manzil guruh yaratish", authRequired: true },
    component: () => import("../views/taxi/address-category/Add.vue")
  },
  {
    path: "/address/category/detail/:id",
    name: "address_category_detail",
    meta: { title: "Manzil guruh detail", authRequired: true },
    component: () => import("../views/taxi/address-category/Detail.vue")
  },
  ...
  // addresses
  {
    path: "/addresses",
    name: "addresses",
    meta: { title: "Manzillar", authRequired: true },
    component: () => import("../views/taxi/addresses/List.vue")
  },
  {
    path: "/address/create",
    name: "address_create",
    meta: { title: "Manzil qo'shish", authRequired: true },
    component: () => import("../views/taxi/addresses/Add.vue")
  },
  {
    path: "/address/detail/:id",
    name: "address_detail",
    meta: { title: "Manzil haqida", authRequired: true },
