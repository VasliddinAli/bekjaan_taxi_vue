...
import { required, phone, helpers } from "@vuelidate/validators";
...
export default {
  ...
  validations: {
    phone: {
      ...
      phone: helpers.withMessage("Please enter valid phone", phone),
    },
    password: {
                          ...
                          <swiper class="mySwiper" :loop="true" :modules="[Autoplay]" :space-between="20" :autoplay="{ delay: 2500, disableOnInteraction: false }">
                            <swiper-slide>
                              ...
                              <div>
                                ...
                                <p class="font-size-14 mb-0">- Bekjaan User</p>
                              </div>
                            </swiper-slide>
              ...
              <div class="d-flex flex-column h-100">
                ...
                <div class="my-auto">
                  <div>
                    ...
                    <p class="text-muted">Sign in to continue to Bekjaan.</p>
                  </div>
                
                  <div class="mt-4">
                    <BForm @submit.prevent="tryToLogIn">
                      <BFormGroup class="mb-3" id="input-group-1" label="Email" label-for="input-1">
                        <BFormInput id="input-1" v-model="phone" type="text" placeholder="Enter phone" :class="{
                          'is-invalid': submitted && v$.phone.$error,
                          'is-valid': submitted && !v$.phone.$error,
                        }">
                        </BFormInput>
                        <div v-if="submitted && v$.phone.$error" class="invalid-feedback">
                          <span v-if="!v$.phone.required">Email is required.</span>
                          <span v-if="!v$.phone.phone">Please enter valid phone.</span>
                        </div>
                      </BFormGroup>
