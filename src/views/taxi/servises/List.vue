<template>
    <Layout>
        <PageHeader title="Xizmatlar" pageTitle="Dashboard" />
            ...
            <BCol lg="12">
                <BCard no-body>
                    <BCardBody class="border-bottom">
                        <BRow class="g-3">
                            <BCol xxl="8" lg="6">
                                <BButton variant="primary" :to="{ name: 'servise_create' }">
                                    Xizmat qo'shish
                                </BButton>
                            </BCol>
                            <BCol xxl="4" lg="6">
                            ...
                            <BTableSimple class="align-middle dt-responsive nowrap w-100 table-check table-bordered"
                                ...
                                <BThead>
                                    <BTr>
                                        ...
                                        <BTh scope="col" style="min-width: 100px;">Narxi</BTh>
                                ...
                                <BTbody>
                                    <BTr v-for="servise in servises" :key="servise.id">
                                        <BTd scope="row"> {{ servise.id }} </BTd>
                                        <BTd scope="row">
                                            <router-link :to="{ name: 'servise_detail', params: { id: servise.id } }">
                                                {{ servise.name }}
                                            </router-link>
                                        </BTd>
                                        <BTd scope="row"> {{ servise.cost }} UZS </BTd>
                                        <BTd scope="row"> {{ servise.status }} </BTd>
                                        <BTd>
